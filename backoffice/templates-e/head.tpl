...
<!-- begin jquery -->
<script src="{c2r-libs}/jquery-3.4.1/jquery-3.4.1.min.js" charset="utf-8"></script>
<!-- end jquery -->

<!-- begin bootstrap -->
<script src="{c2r-libs}/popper-1.14.7/popper.min.js" charset="utf-8"></script>
<link rel="stylesheet" href="{c2r-libs}/bootstrap-4.3.1/css/bootstrap.min.css">
<script src="{c2r-libs}/bootstrap-4.3.1/js/bootstrap.min.js" charset="utf-8"></script>
